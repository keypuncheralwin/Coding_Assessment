...
class TestSort(unittest.TestCase):
    ...
    def test_check_file_4(self):
        file = './csv_files/test_data3.csv'
        result = sort.sortFile(file)
        expected = "Invalid column names, please reformat the contents of the file and try again"
        self.assertEqual(result,expected)
